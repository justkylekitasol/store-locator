	...
	$.extend(Plugin.prototype, {
		...
		_formEventHandler: function () {
          ...
          $("#bh-sl-user-location").submit(function() {
            $("#loc-value").text($("#bh-sl-address").val());
          });
				});
			}
      ...
      // h6.className = `header-text featured-header`;
      // var text = document.createTextNode("Featured Location");
      // h6.appendChild(text);
      // const container = document.querySelector('.featured-list');
      // const main = document.querySelector('.featured-loc_wrapper');
      // container.insertBefore(h6, main);
      $("#bh-sl-user-location").submit(function() {
        $("#loc-value").text($("#bh-sl-address").val());
      });
